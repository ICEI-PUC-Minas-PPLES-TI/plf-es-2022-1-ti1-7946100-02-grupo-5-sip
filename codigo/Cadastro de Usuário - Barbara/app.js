...
let tipoCadastroSindico = document.querySelector('#campoCadastroSindico');
let labelCadasroSindico = document.querySelector('#labelCadasroSindico');

let tipoCadastroUsuario = document.querySelector('#campoCadastroUsuario');
let labelCadastroUsuario = document.querySelector('#labelCadastroUsuario');
...
nomeUsuario.addEventListener('keyup', ()=> {
    if(nomeUsuario.value.length < 4){
        ...
        labelNomeUsuario.innerHTML = 'Nome de Usuário *Campo Nome de Usuário deve ter mais de 3 caracteres';
    ...
    if(validarPreenchimentoNome && validarPreenchimentoSobrenome && 
        ...
        validarPreenchimentoNomeUsuario && validarPreenchimentoSenha){           
            ...
            listaUsuarios.push({
                ...
                senha: senha.value,
                tipoCadastroUsuario: tipoCadastroUsuario.value,
                tipoCadastroSindico: tipoCadastroSindico.value
            })
            ...
            window.location.href = 'lista_usuarios_cadastrados.html';
